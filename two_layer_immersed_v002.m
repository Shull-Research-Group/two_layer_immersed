...
%I am implementing other changes to this program
...
for dum=1:length(radiotot)
   ...
   try
        ...
        disp(['exitflag: ',num2str(exitflag),', resnorm: ',num2str(resnorm),', # of pts solved: ',num2str(count)]);
...
handles.din.rawdata.abs_freq(index2,harm+1)=fdata(index,2);
handles.din.rawdata.abs_freq(index2,harm+2)=gdata(index,2);
